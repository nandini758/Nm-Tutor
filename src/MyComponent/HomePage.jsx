function HomePqage(){
    return(
        <div className="flex overflow-hidden relative flex-col items-center px-16 pt-1 pb-3.5 text-center text-white min-h-[217px] max-md:px-5 bg-black"  >
      ...
      <div className="relative w-full max-w-[1688px] max-md:max-w-full ">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          ...
          <iframe style={{marginTop:"20%"}} width="560" height="315" src="https://www.youtube.com/embed/trudesxpln8?si=yHY3d4EczgmyiZhE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </div>
