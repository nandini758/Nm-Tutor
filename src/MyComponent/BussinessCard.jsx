...
const BussinessCard = ({ data, index }) => {
    return (
        ...
        <div className='py-10' style={{ backgroundColor: index === 0 || index === 3 || index === 6 || index === 9 ? "#FFBD39" : index === 2 || index === 5 || index === 8 || index === 11 ? "#0BA042" : "#2B2B2B" }}>

            <div className='max-w-[1100px]  mx-auto gap-5 grid grid-cols-4 p-5'>
                ...
                <div className=' flex justify-center items-center'>
                    <div className="flex flex-col justify-center w-full py-4 text-2xl font-bold leading-6 text-center text-white uppercase bg-green-500 rounded-xl shadow-sm max-md:pr-6 max-md:pl-6">
                        Value:
                        <br />
