        ...
        <div className="flex flex-col items-center text-base">
            <div className="flex justify-center items-center self-stretch lg:px-16 py-16 w-full bg-black  max-md:max-w-full">
                <div className="flex flex-col items-center mt-3.5 max-w-full w-[1026px]">
                    ...
                    <div className="flex flex-col gap-4 justify-center px-11 pt-11 pb-16 mt-8 max-w-full font-medium text-black border-2 border-yellow-400 border-dashed rounded-[50px] w-[450px] max-md:px-5">
                        <input type='text' placeholder='Name' className="justify-center items-start p-4 whitespace-nowrap bg-white rounded-xl border border-solid border-stone-500 max-md:pr-5" />
                        <input type='email' placeholder='Email' className="justify-center items-start p-4 whitespace-nowrap bg-white rounded-xl border border-solid border-stone-500 max-md:pr-5" />
                        <input type='text' placeholder='WhatsApp Number' className="justify-center items-start p-4 whitespace-nowrap bg-white rounded-xl border border-solid border-stone-500 max-md:pr-5" />

                        <div className="justify-center items-center px-16 py-4 text-center text-pink-600 bg-yellow-400 rounded-xl leading-[150%] max-md:px-5">
                            Submit Now
                        </div>
                    </div>
